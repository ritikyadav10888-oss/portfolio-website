const Logo = ({ width = 40, height = 40 }) => (
    <svg width={width} height={height} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Ritik Yadav Portfolio Logo">
        <title>Ritik Yadav Portfolio Logo</title>
